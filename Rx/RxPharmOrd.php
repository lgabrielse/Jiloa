...
<form id="formrx3" name="formrx3" method="post" action="<?php echo $editFormAction; ?>"> 
    <table border="1" align="center"  bgcolor="#F8FDCE">
     ...
     <tr>
	  ...
	  <tr>
	    <td nowrap="nowrap"><input name="Submit" type="submit" id="Submit" style="background-color:aqua; border-color:blue; color:black;text-align: center;border-radius: 4px;" value="ReOrder" /></td>
	  </tr>
