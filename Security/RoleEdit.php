			...
			Edit Role 
			  ...
			  <tr>
				<td><a href="RoleMenu.php">Close</a>
				  ...
				  <input type="hidden" name="MM_update" value="form1"></td><td><input type="submit" name="Submit" style="background-color:aqua; border-color:blue; color:black;text-align: center;border-radius: 4px;" value="Edit Role" /></td>
			  </tr>
		</table>   
      </form>	</td>
  </tr>
