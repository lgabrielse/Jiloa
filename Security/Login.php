...
<?php $_SESSION['PtInfoReq'] = ''; ?>
<?php $_SESSION['PtPicReq'] = ''; ?>
<?php $_SESSION['Outreach'] = ''; ?> 
<?php
...
<?php $_SESSION['uid'] = $row_loguser['id']; ?>
...
if (isset($_SESSION['user']) ) {
	...
	$mysessioncookie = json_encode($_SESSION);  // $mysessioncookie; = all the session values
	  ...
	  <tr>
		...
		<td>
			<table width="300" border="1">
			  ...
			  <tr>
				<td>&nbsp;</td>
				<td><input type="submit" name="Submit" style="background-color:aqua; border-color:blue; color:black;text-align: center;border-radius: 4px;" value="LOGIN" /></td>
			  </tr>
