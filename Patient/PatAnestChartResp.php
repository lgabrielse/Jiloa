...
$query_anestid = "SELECT anestid, schedt, vital, value, value2 FROM ipvitals WHERE anestid = '".$colname_anestid."' and vital = 'resp' ORDER BY schedt ASC";
...
$textBoxObj = $c->addTitle("RESPIRATION RATE", "timesbi.ttf", 10, 0xffffff);  //use .Chr(10). for new line
...
$c->yAxis->setLinearScale(10, 40, 5);
...
# ranges 0 - 10, 10 - 20... and 50 - max.
$c->yAxis->addZone(10, 12, 0xff9999);
#$c->yAxis->addZone(12, 18, 0xffff99);
$c->yAxis->addZone(12, 18, 0x99ff99);
$c->yAxis->addZone(18, 25, 0xffff99);
$c->yAxis->addZone(25, 9999, 0xff9999);
