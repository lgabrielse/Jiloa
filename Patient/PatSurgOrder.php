...
<table>
  <tr>
    <td>&nbsp;</td>
    <td><form id="formSurgAdd" name="formSurgAdd" method="post" action="checkbox-form.php" >
      <table>
        <tr>
          <td bgcolor="#DCDCDC"><div align="center" class="BlackBold_16">Ordered</div></td>
          <td bgcolor="#DCDCDC"><div align="center"><a href="PatShow1.php?mrn=<?php echo $_SESSION['mrn']; ?>&vid=<?php echo $_SESSION['vid']; ?>&visit=PatVisitView.php&act=lab&pge=PatSurgEdit.php">Close</a></div>
		...
		?>
                ...
                <td rowspan="2"><input name="medrecnum" type="hidden" id="medrecnum" value="<?php echo $_SESSION['mrn']; ?>" />
                    <input type="hidden" name="MM_insert" value="formSurgAdd" />
                    ...
                    <input name="qrystr" type="hidden" id="qrystr" value="<?php echo 'mrn='.$colname_mrn.'&vid='.$colname_vid.'&visit=PatVisitView.php&act=lab&pge=PatSurgEdit.php' ?>" />
			<?php if(allow(51,3) == 1) { ?>
                ...
                <?php } while ($row_ordered = mysql_fetch_assoc($ordered)); ?>
				  ...
				  <td valign="top" class="subtitlebk" align="center">
					<table>
					  ...
					  <table>
						...
						<?php do { ?>
						<tr>
						  <td ><input type="radio" name="surgorder" value="<?php echo $row_minor['id']; ?>" /></td>
				  ...
				  <td valign="top" class="subtitlebk"align="center">
					  <table>
						...
						<?php do { ?>
						<tr>
						  <td><input type="radio" name="surgorder" value="<?php echo $row_Interm['id']; ?>" /></td>
				  ...
				  <td valign="top" align="center" class="subtitlebk">
					  <table>
						...
						<?php do { ?>
						<tr>
						  <td><input type="radio" name="surgorder" value="<?php echo $row_major['id']; ?>" /></td>
...
<script  type="text/javascript">
 var frmvalidator = new Validator("formSurgAdd");
