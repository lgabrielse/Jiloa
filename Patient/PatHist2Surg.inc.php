...
<table width="1000px" border="1" cellpadding="1" cellspacing="1" bgcolor="#f9d2f9">
		<?php   $bgc = "#CCCCCC";
				...
				if($row_surg['status'] == 'Cancelled'){ $bgc = "#e6442e"; }
		?>
...
<!--Surgical Items Count gueries-->
<?php
mysql_select_db($database_swmisconn, $swmisconn);
$query_begincnt = "SELECT id, surgid, swabs, arteryforceps, aliceforceps, toothdissectingforceps, plaindisectingforceps, abdominalmops, scissors, bladehandles, blades, grayaimitage, langendeckretractor, doyensretractor, needleholders, needles, entryby, entrydt FROM surgcountbegin WHERE surgid = '".$row_surg['sid']."'";
...
mysql_select_db($database_swmisconn, $swmisconn);
$query_endcnt = "SELECT id, surgid, swabs, arteryforceps, aliceforceps, toothdissectingforceps, plaindisectingforceps, abdominalmops, scissors, bladehandles, blades, grayaimitage, langendeckretractor, doyensretractor, needleholders, needles, entryby, entrydt FROM surgcountend WHERE surgid = '".$row_surg['sid']."'";
...
?>
<table width="1000" border="1" style="border-collapse: collapse;" bgcolor="#f9d2f9">
  <tr>
    <td colspan="16" class="BlueBold_24"><span>Surgical Items Count</span></td>
    </tr>
  <tr>
    <td>Item</td>
    <td align="center">Swabs</td>
    <td align="center">Art<br />
      frcps</td>
    <td align="center">Alice<br />
      frcps
    </td>
    <td align="center">Tooth<br />
      frcps
    </td>
    <td align="center">Plain<br />
      frcps
    </td>
    <td align="center">Abdom<br />
      mops
    </td>
    <td align="center">Scis<br />
      sors</td>
    <td align="center">Blade<br />
      handles
    </td>
    <td align="center">Blades</td>
    <td align="center">Gray<br />
      aimitage
    </td>
    <td align="center">Lang<br />
      retract
    </td>
    <td align="center">Doyens<br />
      retract
      <br />
    </td>
    <td align="center">Needle<br />
      holders
    </td>
  ...
  <tr>
    <td>Begin</td>
    <td align="center"><?php echo $row_begincnt['swabs']; ?></td>
    <td align="center"><?php echo $row_begincnt['arteryforceps']; ?></td>
    <td align="center"><?php echo $row_begincnt['aliceforceps']; ?></td>
    <td align="center"><?php echo $row_begincnt['toothdissectingforceps']; ?></td>
    <td align="center"><?php echo $row_begincnt['plaindisectingforceps']; ?></td>
    <td align="center"><?php echo $row_begincnt['abdominalmops']; ?></td>
    <td align="center"><?php echo $row_begincnt['scissors']; ?></td>
    <td align="center"><?php echo $row_begincnt['bladehandles']; ?></td>
    <td align="center"><?php echo $row_begincnt['blades']; ?></td>
    <td align="center"><?php echo $row_begincnt['grayaimitage']; ?></td>
    <td align="center"><?php echo $row_begincnt['langendeckretractor']; ?></td>
    <td align="center"><?php echo $row_begincnt['doyensretractor']; ?></td>
    <td align="center"><?php echo $row_begincnt['needleholders']; ?></td>
    <td align="center"><?php echo $row_begincnt['needles']; ?></td>
    <td align="center"><?php echo $row_surg['begincount']; ?></td>
  </tr>
  <tr>
    <td>End</td>
    <td align="center"><?php echo $row_endcnt['swabs']; ?></td>
    <td align="center"><?php echo $row_endcnt['arteryforceps']; ?></td>
    <td align="center"><?php echo $row_endcnt['aliceforceps']; ?></td>
    <td align="center"><?php echo $row_endcnt['toothdissectingforceps']; ?></td>
    <td align="center"><?php echo $row_endcnt['plaindisectingforceps']; ?></td>
    <td align="center"><?php echo $row_endcnt['abdominalmops']; ?></td>
    <td align="center"><?php echo $row_endcnt['scissors']; ?></td>
    <td align="center"><?php echo $row_endcnt['bladehandles']; ?></td>
    <td align="center"><?php echo $row_endcnt['blades']; ?></td>
    <td align="center"><?php echo $row_endcnt['grayaimitage']; ?></td>
    <td align="center"><?php echo $row_endcnt['langendeckretractor']; ?></td>
    <td align="center"><?php echo $row_endcnt['doyensretractor']; ?></td>
    <td align="center"><?php echo $row_endcnt['needleholders']; ?></td>
    <td align="center"><?php echo $row_endcnt['needles']; ?></td>
    <td align="center"><?php echo $row_surg['endcount']; ?></td>
  </tr>
</table>
...
<!--  section to add, edit, delete drugs for surgery/anesthesia   section to add, edit, delete drugs for surgery/anesthesia   -->       
    ...
    <?php if($totalRows_anestdrugs > 0) { ?>
        <table  cellpadding="0" cellspacing="0" bordercollapse="collapse"  bgcolor="#F8FDCE">
          <tr>
            <td align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
          ...
          <?php do { ?>
            <tr>
              <td title="ID: <?php echo $row_anestdrugs['id']; ?>&#10;anest ID: <?php echo $row_anestdrugs['anestid']; ?>">&nbsp;<?php echo $totalRows_anestdrugs ?> </td>
...
<table>
  <tr>
  	<td><div>
			<img src="PatHist2Gantt.php?aid=<?php echo $row_anestintraop['aid'] ?>&ba=<?php echo $aneststarttime ?>&ea=<?php echo $anestendtime ?>&bs=<?php echo $surgstarttime ?>&es=<?php echo $surgendtime ?>" alt="ChartAnest">
		</div></td>
  </tr>
</table>
...
<table width="50%" border="1" bgcolor="#ffedcc" cellpadding="1" cellspacing="1">
  ...
  <tr>
    <td nowrap="nowrap">status:
          <input type="text" name="status2" id="status2" value="<?php echo $row_anestpostop['status'] ?>"/></td>
...
<p class="BlueBold_24"> <?php echo str_repeat("&#9856;",60);?></p> 
<p class="BlueBold_24"> <?php echo str_repeat("&#9856;",60);?></p> 
