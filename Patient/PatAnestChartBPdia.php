...
//$data = array(40, 60, 80, 100, 90, 80, 90, 70);  #diastolic
//$readtime = array(1592411400, 1592412900, 1592414700, 1592415600, 1592419200, 1592426400,1592430000); # time of readings
...
$value = array();
 do { 
	...
	array_push($value, $row_anestid['value2']);
...
$textBoxObj = $c->addTitle("DIASTOLIC BLOOD PRESSURE", "timesbi.ttf", 10, 0xffffff);  //use .Chr(10). for new line
...
$c->yAxis->setLinearScale(20, 150, 20);
...
# ranges 40-50,60-79... 100- max.
$c->yAxis->addZone(20, 35, 0xff9999);
$c->yAxis->addZone(35, 50, 0xffff99);
$c->yAxis->addZone(50, 89, 0x99ff99);
$c->yAxis->addZone(89, 120, 0xffff99);
$c->yAxis->addZone(120, 9999, 0xff9999);
