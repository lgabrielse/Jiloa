...
<?php  // Orders where amtdue = 0 and amtpaid > 0  - should be 0
mysql_select_db($database_swmisconn, $swmisconn);
$query_orders = "Select DATE_FORMAT(o.entrydt,'%Y-%m-%d') entrydt, o.medrecnum, o.visitid, o.id ordid, o. ofee, o.amtdue oamtdue, o.amtpaid oamtpaid, o.billstatus, r.status, r.amtdue roamtdue, r.amtpaid roamtpaid from orders o join rcptord r on o.id = r.ordid where o.amtdue = 0 and o.amtPaid > 0 and o.billstatus NOT LIKE 'Refund%'";
...
<p align="center"><a href="ValidationMenu.php">Menu</a> -Orders where amtdue = 0 and amtpaid > 0  - should be 0</p>
<p>&nbsp;</p>
<table border="1" align="center" cellpadding="1" cellspacing="1" class="tablebc">
  ...
  <?php do { ?>
    <tr>
      ...
      <td class="BlueBold_1212"><?php echo $row_orders['oamtdue']; ?></td>
      ...
      <td class="BlueBold_1212"><?php echo $row_orders['roamtdue']; ?></td>
