...
$mysqldb="swmisswmis"; // name of database
$path = "C:\wamp\www\Len\Jiloa\Backup\AutoSwmis"; // full server path to the directory where you want the backup files (no trailing slash)
//$path = "F:\SWMIS";
// modify the above values to fit your environment
$sqlfile = "/SwmisBackup" . date("d") . ".sql";
$filename = $path . "/SwmisBackup" . date("d") . ".sql";
...
$insertSQL = sprintf("INSERT INTO backuplog (pgm, path, dabase, sqlfile, size, user, entrydt ) VALUES (%s, %s, %s, %s, %s, %s, %s)",
			 GetSQLValueString('AutoSwmis', "text"),
