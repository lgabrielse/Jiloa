...
and v.status like '%".$colname_vstatus."%' and v.pat_type like '%".$colname_pat_type."%' and v.location like '%".$colname_location."%' and visitdate <= SYSDATE() - INTERVAL 14 DAY Order BY v.id";  //and visitdate >= SYSDATE() - INTERVAL 200 DAY 
...
<body>
<p align="center"><span class="navLink"><a href="ReportsMenu.php">Report Menu </a></span>&nbsp;&nbsp;&nbsp;<span class="BlueBold_16"> These <?php echo $totalRows_currPat ?> undischarged patients have a diagnosis and Lab tests done and can be discharged after 14 days. </span></p>
...
<p align="center" class="BlueBold_16">These <?php echo $totalRows_dischPat2 ?> undischarged patients have visit dates greater than 14 days ago and have a diagnosis. </p>
<table align="center">
  <tr>
    <td class="BlackBold_14"><div align="center">MRN</div></td>
    <td class="BlackBold_14"><div align="center">LAST NAME </div></td>
...
<p align="center" class="BlueBold_16">These <?php echo $totalRows_dischPat7 ?> undischarged patients have visit dates greater than 14 days ago. </p>
<table align="center">
  <tr>
    <td class="BlackBold_14"><div align="center">MRN</div></td>
    <td class="BlackBold_14"><div align="center">LAST NAME </div></td>
